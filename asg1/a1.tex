...
\begin{enumerate}
        \item
              ...
              \begin{proof}
                      ...
                      \begin{center}
                              Given that k is negative,\\
                              ${x\geq y} \rightarrow {kx\leq ky}$
                      \end{center}
              \end{proof}
              \begin{enumerate}
              ...
              \begin{proof}
                      ...
                      \end{enumerate}
                      Consider the zero function $\mathbf{0}$ defined by $\mathbf{0}(x)=0$ for all $x$. Then clearly $\mathbf{0}(1)=f(1)=0$ so $W$ is non-empty.
